...
const Navbar = () => {
  return (
    <nav className="bg-black text-white shadow-lg sticky w-full z-50 top-0 left-0 xs:pr-8 md:px-8 lg:px-16">
      ...
      <img className='invert xs:h-6 xs:w-6 sm:h-8 sm:w-8' src='/logo.png'/>
          
          <p className="font-normal xs:text-xs sm:text-xl sm:font-bold font-mono">Vevy Web Solutions</p>
        </div>
