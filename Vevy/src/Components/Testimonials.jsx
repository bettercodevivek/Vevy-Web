...
const TestimonialsPage = () => {
  return (
    <section className="min-h-screen bg-gray-50 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
              <div
                className={`flex items-center space-x-4 ${
                  index % 2 === 0 ? 'text-left pl-8' : 'text-right flex-row-reverse space-x-reverse pr-8'
                }`}
              >
                <img
